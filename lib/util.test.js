...
test('combineParams: {foo: \'bar\',faz: \'baz\',fiz: \'biz\'}', () => {
  expect(combineParams({ foo: 'bar', faz: 'baz', fiz: 'biz' })).toEqual(
...
test('combineParams: {foo:\'bar\',faz:\'baz\'} w/ hasParams', () => {
  expect(combineParams({ foo: 'bar', faz: 'baz' }, true)).toEqual(
    '&faz=baz&foo=bar',
  );
});

test('combineParams: {foo: \'bar\',faz: \'baz\',fiz: \'biz\'} w/ hasParams', () => {
  expect(combineParams({ foo: 'bar', faz: 'baz', fiz: 'biz' }, true)).toEqual(
    '&faz=baz&fiz=biz&foo=bar',
  );
});
