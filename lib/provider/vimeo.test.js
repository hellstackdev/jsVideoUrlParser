...
test('Vimeo: undefined', () => {
  ...
  expect(newParser().create({ videoInfo: { provider: 'vimeo' } })).toBe(
    undefined,
  );
  expect(
    newParser().create({
      videoInfo: { provider: 'vimeo', mediaType: 'video' },
    }),
  ).toBe(undefined);
  expect(
    newParser().create({
...
test('Vimeo: urls', () => {
  ...
  testUrls(newParser(), {
    ...
    urls: [
      'https://vimeo.com/album/2903155/video/96186586',
  ...
  testUrls(newParser(), {
    ...
    urls: [
      'https://vimeo.com/groups/shortfilms/videos/97688625',
  ...
  testUrls(newParser(), {
    ...
    urls: [
      'http://vimeopro.com/staff/frame/video/24069938',
  ...
  testUrls(newParser(), {
    ...
    urls: [
      'https://vimeo.com/36881035#t=3m28s',
  ...
  testUrls(newParser(), {
    ...
    urls: [
      'https://vimeo.com/36881035/f9ad567296',
