...
test('YouTube: undefined', () => {
  ...
  expect(
    newParser().create({ videoInfo: { provider: 'youtube' }, format: 'long' }),
  ).toBe(undefined);
  expect(
    newParser().create({
      videoInfo: { provider: 'youtube', mediaType: 'video' },
      format: 'long',
    }),
  ).toBe(undefined);
  expect(
    newParser().create({
      videoInfo: { provider: 'youtube', mediaType: 'playlist' },
      format: 'long',
    }),
  ).toBe(undefined);
  expect(
    newParser().create({
      videoInfo: { provider: 'youtube', mediaType: 'share' },
      format: 'long',
    }),
  ).toBe(undefined);
  expect(
    newParser().create({ videoInfo: { provider: 'youtube' }, format: 'embed' }),
  ).toBe(undefined);
  expect(
    newParser().create({
      videoInfo: { provider: 'youtube', mediaType: 'video' },
...
test('YouTube: regular urls', () => {
  ...
  testUrls(newParser(), {
    ...
    formats: {
      embed:
        'https://www.youtube.com/embed/HRb7B9fPhfA?loop=1&playlist=HRb7B9fPhfA&start=30',
    },
...
test('YouTube: playlist urls', () => {
  testUrls(newParser(), {
    ...
    formats: {
      long:
        'https://www.youtube.com/watch?list=PL46F0A159EC02DF82&v=yQaAGmHNn9s#t=100',
      embed:
  ...
  testUrls(newParser(), {
    ...
    formats: {
      long:
        'https://www.youtube.com/watch?index=25&list=PL46F0A159EC02DF82&v=6xLcSTDeB7A',
      embed:
  ...
  testUrls(newParser(), {
    ...
    formats: {
      long:
        'https://www.youtube.com/watch?index=25&list=PL46F0A159EC02DF82&v=6xLcSTDeB7A#t=100',
      embed:
  ...
  testUrls(newParser(), {
    ...
    formats: {
      long:
        'https://www.youtube.com/playlist?feature=share&list=PL46F0A159EC02DF82',
      embed:
        'https://www.youtube.com/embed?list=PL46F0A159EC02DF82&listType=playlist',
      short: undefined,
