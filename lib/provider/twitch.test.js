...
test('Twitch: undefined', () => {
  ...
  expect(newParser().create({ videoInfo: { provider: 'twitch' } })).toBe(
    undefined,
  );
  expect(
    newParser().create({
      videoInfo: { provider: 'twitch', mediaType: 'stream' },
    }),
  ).toBe(undefined);
  expect(
    newParser().create({
  ...
  expect(
    newParser().create({
      videoInfo: { provider: 'twitch', mediaType: 'clip' },
    }),
  ).toBe(undefined);
  expect(
    newParser().create({
